<div class="page-modale">
    ...
    <div class="page-modale-contenu">
        <div class="carte carte-form">
            <h2 style="margin-top:0;margin-bottom:.6rem">Modifier l'affectation N°<?= e($affectation['numero_arrete']) ?></h2>
            <p style="color: var(--txt-2); font-size: .85rem; margin-bottom: 1.2rem">
                ...
                <br>Seuls le numero d'arrete et les dates peuvent etre corriges.
            </p>
